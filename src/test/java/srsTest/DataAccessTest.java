...
public class DataAccessTest {
	// public final String DEFAULTTIMESLOTFACTORYNAME =
	// "ch.bfh.due1.time.pojo.TimeSlotFactoryImpl";
	//
	...
	// String className = System.getProperty("timeslotfactory.name",
	// DEFAULTTIMESLOTFACTORYNAME);
	...
	// Booker b = this.dataAccess.registerBooker("Hans", "Muster",
	// "hans@muster.ch");
	...
	// Booker b1 = this.dataAccess.registerBooker("Hans", "Muster",
	// "hans@muster.ch");
	...
	// Booker b1 = this.dataAccess.registerBooker("Hans", "Muster",
	// "hans@muster.ch");
	// Booker b2 = this.dataAccess.registerBooker("Fritz", "Meier",
	// "hans@muster.ch");
	// List<Booker> all = this.dataAccess.getAllBookers();
	//
	...
	// this.dataAccess.insertRoomEquipment("Beamer",
	// // 2);
	// //
	...
	// SystemUser u = this.dataAccess.registerSystemUser("Hans", "Muster",
	// "hans@muster.ch", "111", true);
	...
	// SystemUser u = this.dataAccess.registerSystemUser("Hans", "Muster",
	// "hans@muster1.ch", "111", true);
	// String newFirstName = "Hansli";
	// String newLastName = "Musterli";
	// String newPassword = "222";
	//
	// this.dataAccess.editSystemUser(newFirstName, newLastName, newPassword,
	// u.getId());
	//
	...
	// SystemUser u1 = this.dataAccess.registerSystemUser("Hans", "Muster",
	// "hans@muster2.ch", "111", true);
	// SystemUser u2 = this.dataAccess.registerSystemUser("Fritz", "Meier",
	// "fritz@meier.ch", "222", false);
	// List<SystemUser> all = this.dataAccess.getAllSystemUsers();
	//
