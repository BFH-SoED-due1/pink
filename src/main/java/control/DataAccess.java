...
public abstract class DataAccess {
	...
	// */
	// public abstract Booker registerBooker(String firstName, String lastName,
	// String email);
	//
	// /**
	...
	// * @return the inserted Booker
	// */
	// public abstract Booker editBooker(String firstName, String lastName, Long
	// id);
	//
	// /**
	...
	// * @return the inserted Room
	// */
	// public abstract Room editRoom(int size, String name, String description,
	// Long id);
	//
	// /**
	...
	// * @return the inserted Eqiupment
	// */
	// public abstract RoomEquipment editRoomEquipment(String name, int qty,
	// Long id);
	//
	// /**
	// * Delets Room from DB
	...
	// */
	// public abstract SystemUser registerSystemUser(String firstName, String
	// lastName, String email, String password, boolean isAdmin);
	//
	// /**
	...
	// * @return the Users
	// */
	// public abstract SystemUser editSystemUser(String firstName, String
	// lastName, String password, Long id);
	//
	// /**
	...
	// */
	// public abstract Reservation insertReservation(Room room, TimeSlot
	// timeSlot, Booker booker);
	//
	// /**
